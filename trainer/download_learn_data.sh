...
if [[ ! -e trainer/chromedriver ]]; then
  ...
  googleimagesdownload -ri -cd "trainer/chromedriver" -k "ラーメン" -f "jpg" -l 1000
  googleimagesdownload -ri -cd "trainer/chromedriver" -k "画像" -f "jpg" -l 1000
  googleimagesdownload -ri -cd "trainer/chromedriver" -k "写真" -f "jpg" -l 1000
  googleimagesdownload -ri -cd "trainer/chromedriver" -k "静止画" -f "jpg" -l 1000
fi